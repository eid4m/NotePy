...
if platform.system() == "Windows":
    root.iconbitmap("img/notepad.ico")
else:
...
text.config(bd=0, padx=6, pady=4, font=("Courier", 16), wrap=NONE)
...
def open_file():
    ...
    url_file = f.askopenfilename(initialdir='.', filetypes=[("Todos los archivos", "*"), ("Documento de texto", "*.txt"), ("Documento RTF", "*.rtf"), ("Archivo Markdown", "*.md"), ("Archivo Python", "*.py"), ("Archivo HTML", "*.html"), ("Archivo CSS", "*.css"), ("Archivo Javascript", "*.js")], title="Abrir archivo")
    if url_file != "":
...
def save_file_as(event=None):
    global url_file
    url_file = f.asksaveasfile(initialdir='.', filetypes=[("Documento de texto", "*.txt"), ("Documento RTF", "*.py"), ("Archivo Markdown", "*.md"), ("Archivo Python", "*.py"), ("Archivo HTML", "*.html"), ("Archivo CSS", "*.css"), ("Archivo Javascript", "*.js"), ("Escriba una extensión", "*"),], title="Guardar archivo como")
    content = text.get(1.0, "end-1c")
